...
$insert = $conn->prepare("INSERT INTO job_applications (username, email, cv, worker_id, job_id) 
VALUES (:username, :email, :cv, :worker_id, :job_id)");
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <input type="hidden" name="username" value= "<?php echo $_SESSION['username']; ?>" class="form-control" id="" placeholder="useranme">
              </div>
              <div class="form-group">
            ...
            <input type="hidden" name="company_id	" value= "<?php echo $row->company_id; ?>"class="form-control" id="" placeholder="company_id">
              ...
              <div class="col-6">
                <button style="padding: 23px 120px; margin-top: -18px;" name="submit_application" type="submit" class="btn btn-inline btn-primary btn-md">Apply</button>
              </div>
             </form>
             
             <?php else: ?>
              <div class="col-6">
                <h3 style="padding: 23px 120px; margin-top: -18px;"class="btn btn-inline">You already applied for this job</h3>
              </div>
              <?php endif; ?>
            ...
            <?php endif; ?> 
            <?php else : ?>
              <h2>login to apply for this job </h2>
              <?php endif; ?>  
            ...
            <div class="row mb-5">
              <div class="col-6">
              <a href="<?php echo APPURL;?>/jobs/job-update.php?id=<?php echo $row->id;?>" class="btn btn-block btn-primary btn-md">Update</a>
                <!--add text-danger to it to make it read-->
              </div>
              <div class="col-6">
              <a style="margin-left: 200px" href="<?php echo APPURL;?>/jobs/job-delete.php?id=<?php echo $row->id;?>" class="btn btn-block btn-danger btn-md">Delete</a>
              </div>
            </div>
            <?php endif; ?>
            <?php endif; ?>
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                <li class="mb-2"><strong class="text-black">Published on: <?php echo date('M', strtotime($row->created_at)) . '' . date('d', strtotime($row->created_at)) . ',' . date('Y', strtotime($row->created_at));?></li>
            ...
            <div class="bg-light p-3 border rounded">
              ...
              <a href= "https://www.facebook.com/sharer/sharer.php?u=<?php echo APPURL;?>/jobs/job-single.php?id=<?php echo $row->id; ?>&quote=<?php echo $row->job_title; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-facebook"></span></a>
                <a href="https://twitter.com/intent/tweet?text=<?php echo APPURL;?>/jobs/job-single.php?id=<?php echo $row->id; ?>&quote=<?php echo $row->job_title; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-twitter"></span></a>
                <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo APPURL;?>/jobs/job-single.php?id=<?php echo $row->id; ?>&quote=<?php echo $row->job_title; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-linkedin"></span></a>
              </div>
            </div>
